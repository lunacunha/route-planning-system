...
class Edge {
public:
    Edge(Vertex<T> *orig, Vertex<T> *dest, double drive, double walk);
...
template <class T>
Edge<T>::Edge(Vertex<T> *orig, Vertex<T> *dest, double drive, double walk): orig(orig), dest(dest), driving(drive), walking(walk) {}
 ...
 */
template <class T>
bool Graph<T>::addEdge(const T &sourc, const T &dest, double drive, double walk) {
